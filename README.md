Wed Sep  8 07:26:36 PM MDT 2021
```bash
System Memory
...
Build at: 2021-09-09T01:27:51.537Z - Hash: ebf6a2de77bd676739b1 - Time: 35324ms
Done in 40.26s.
```
```bash
yarn run v1.22.11
$ ng test
08 09 2021 19:28:01.493:INFO [karma-server]: Karma v6.3.2 server started at http://localhost:9876/
08 09 2021 19:28:01.496:INFO [launcher]: Launching browsers FirefoxHeadless with concurrency unlimited
08 09 2021 19:28:01.499:INFO [launcher]: Starting browser Firefox
08 09 2021 19:28:09.200:INFO [Firefox 91.0 (Fedora 0.0.0)]: Connected on socket iOJBb-fiMKWnLq2-AAAB with id 68894947
...
[1A[2KFirefox 91.0 (Fedora 0.0.0): Executed 1 of 3[32m SUCCESS[39m (0 secs / 0.112 secs)
[1A[2KERROR: [36m'NG0304: 'mat-icon' is not a known element:
1. If 'mat-icon' is an Angular component, then verify that it is part of this module.
2. If 'mat-icon' is a Web Component then add 'CUSTOM_ELEMENTS_SCHEMA' to the '@NgModule.schemas' of this component to suppress this message.'[39m
Firefox 91.0 (Fedora 0.0.0): Executed 1 of 3[32m SUCCESS[39m (0 secs / 0.112 secs)
ERROR: 'NG0304: 'mat-icon' is not a known element:
1. If 'mat-icon' is an Angular component, then verify that it is part of this module.
2. If 'mat-icon' is a Web Component then add 'CUSTOM_ELEMENTS_SCHEMA' to the '@NgModule.schemas' of this component to suppress this message.'
...
Done in 18.07s.
```
Wed Sep  8 07:28:10 PM MDT 2021
